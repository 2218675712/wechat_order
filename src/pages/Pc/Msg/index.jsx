            ...
            <div className={Styles.scrollCon}>
                ...
                <div className={Styles.item}>
                    <section
                        ...
                        <aside>
                            <span>手机号</span>
                            <input type="text" value={state.phone.val} disabled={state.phone.state} onChange={(e) => {
                        ...
                        {
                            state.phone.state ?
                                <i className={'iconfont icon-setup_fill'} onClick={() => changeState('phone')}></i> :
                                <p>
                ...
                <div className={Styles.item}>
                    <section
                        ...
                        <aside>
                            <span>邮箱</span>
                            <input type="text" value={state.email.val} disabled={state.email.state} onChange={(e) => {
                        ...
                        {
                            state.email.state ?
                                <i className={'iconfont icon-setup_fill'} onClick={() => changeState('email')}></i> :
                                <p>
                ...
                <div className={Styles.item}>
                    <section
                        ...
                        <aside>
                            <span>性别</span>
                            {
                                state.sex.state ?
                                    (state.sex.val === 0 ? '男' : '女') :
                                    (<>
                                        男 <input type='radio' name='sex' value='0' checked={state.sex.val === "0"}
                                                 onChange={(e) => changeHandle(e, 'sex')}/>
                                        女 <input type='radio' name='sex' value='1' checked={state.sex.val === "1"}
                                                 onChange={(e) => changeHandle(e, 'sex')}/>
                                    </>)
                            }
                        </aside>
                        ...
                        {
                            state.sex.state ?
                                <i className={'iconfont icon-setup_fill'} onClick={() => changeState('sex')}></i> :
                                <p>
